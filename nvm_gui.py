...
class NvMDesktopApp:
    OPERATIONS = {
        ...
        "merge_json": {
            "label": "Merge Previous ARXML with new JSON",
            "input_type": "json",
            "needs_previous": True,
            "allow_update": False,
        },
        "merge_excel": {
            "label": "Merge Previous ARXML with new Excel",
            "input_type": "excel",
            "needs_previous": True,
            "allow_update": False,
        },
        "update_json": {
            "label": "Update Previous ARXML with new JSON",
            "input_type": "json",
            "needs_previous": True,
            "allow_update": True,
        },
        "update_excel": {
            "label": "Update Previous ARXML with new Excel",
            "input_type": "excel",
            "needs_previous": True,
            "allow_update": True,
        },
